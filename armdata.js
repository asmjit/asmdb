...
//         APRS mostly defines APSR writes, as reads are controlled by IT
...
$export[$as] = {
  ...
  instructions: [
    ...
    ["adc"              , "Rd!=XX, Rn!=XX, Rm!=XX, {Type #Shift}"      , "T32", "1110101|1010|0|Rn|0|Shift:3|Rd|Shift:2|Type|Rm"      , "ARMv6T2+ IT=ANY"],
    ["adcs"             , "Rd!=XX, Rn!=XX, Rm!=XX, {Type #Shift}"      , "T32", "1110101|1010|1|Rn|0|Shift:3|Rd|Shift:2|Type|Rm"      , "ARMv6T2+ IT=ANY N=W Z=W C=W V=W APSR_IF_NOT_PC"],
    ...
    ["add"              , "SP, SP, #ImmZ*4"                            , "T16", "1011|00000|ImmZ:7"                                   , "ARMv4T+  IT=ANY"],
    ["add"              , "Rd!=SP, SP, #ImmZ*4"                        , "T16", "10101|Rd:3|ImmZ:8"                                   , "ARMv4T+  IT=ANY"],
    ["add"              , "Rdm, SP, Rdm"                               , "T16", "010001|00|Rdm:1|1101|Rdm:3"                          , "ARMv4T+  IT=ANY"],
    ["add"              , "SP, SP, Rm"                                 , "T16", "010001|00|1|Rm:4|101"                                , "ARMv4T+  IT=ANY"],
    ...
    ["add"              , "Rd!=XX, Rn!=PC, Rm!=XX, {Type #Shift}"      , "T32", "1110101|1000|0|Rn|0|Shift:3|Rd|Shift:2|Type|Rm"      , "ARMv6T2+ IT=ANY"],
    ["adds"             , "Rd!=XX, Rn!=PC, Rm!=XX, {Type #Shift}"      , "T32", "1110101|1000|1|Rn|0|Shift:3|Rd|Shift:2|Type|Rm"      , "ARMv6T2+ IT=ANY"],
    ["add"              , "Rd!=PC, SP, #ImmZ"                          , "T32", "11110|ImmZ:1|1|0000|0|1101|0|ImmZ:3|Rd|ImmZ:8"       , "ARMv6T2+ IT=ANY"],
    ["add"              , "Rd!=PC, SP, #ImmA"                          , "T32", "11110|ImmA:1|0|1000|0|1101|0|ImmA:3|Rd|ImmA:8"       , "ARMv6T2+ IT=ANY"],
    ["adds"             , "Rd!=PC, SP, #ImmA"                          , "T32", "11110|ImmA:1|0|1000|1|1101|0|ImmA:3|Rd|ImmA:8"       , "ARMv6T2+ IT=ANY N=W Z=W C=W V=W"],
    ["add"              , "Rd!=PC, SP, Rm!=XX, {Type #Shift}"          , "T32", "11101|011000|0|1101|0|Shift:3|Rd|Shift:2|Type|Rm"    , "ARMv6T2+ IT=ANY LSL_3_IF_SP"],
    ["adds"             , "Rd!=PC, SP, Rm!=XX, {Type #Shift}"          , "T32", "11101|011000|1|1101|0|Shift:3|Rd|Shift:2|Type|Rm"    , "ARMv6T2+ IT=ANY LSL_3_IF_SP"],
    ...
    ["and"              , "Rd!=XX, Rn!=XX, Rm!=XX, {Type #Shift}"      , "T32", "1110101|0000|0|Rn|0|Shift:3|Rd|Shift:2|Type|Rm"      , "ARMv6T2+ IT=ANY"],
    ["ands"             , "Rd!=XX, Rn!=XX, Rm!=XX, {Type #Shift}"      , "T32", "1110101|0000|1|Rn|0|Shift:3|Rd|Shift:2|Type|Rm"      , "ARMv6T2+ IT=ANY N=W Z=W C=W"],
    ...
    ["bfc"              , "Rd!=XX, #LSB, #Width"                       , "T32", "1111001|1011|0|1111|0|LSB:3|Rd|LSB:2|0|Width"        , "ARMv6T2+ IT=ANY"],
    ["bfi"              , "Rd!=XX, Rn!=XX, #LSB, #Width"               , "T32", "1111001|1011|0|Rn|0|LSB:3|Rd|LSB:2|0|Width"          , "ARMv6T2+ IT=ANY"],
    ...
    ["bic"              , "Rd!=XX, Rn!=XX, Rm!=XX, {Type #Shift}"      , "T32", "11101|01|0001|0|Rn|0|Shift:3|Rd|Shift:2|Type|Rm"     , "ARMv6T2+ IT=ANY"],
    ["bics"             , "Rd!=XX, Rn!=XX, Rm!=XX, {Type #Shift}"      , "T32", "11101|01|0001|1|Rn|0|Shift:3|Rd|Shift:2|Type|Rm"     , "ARMv6T2+ IT=ANY N=W Z=W C=W"],
    ...
    ["blx"              , "Rel*4"                                      , "T32", "11110|Rel[22]|Rel[19:10]|11|J1|0|J2|Rel[9:0]"        , "ARMv4T+  IT=OUT|LAST"],
    ...
    ["orn"              , "Rd!=XX, Rn!=XX, Rm!=XX, {Type #Shift}"      , "T32", "11101|01|0011|0|Rn|0|Shift:3|Rd|Shift:2|Type|Rm"     , "ARMv6T2+ IT=ANY"],
    ["orns"             , "Rd!=XX, Rn!=XX, Rm!=XX, {Type #Shift}"      , "T32", "11101|01|0011|1|Rn|0|Shift:3|Rd|Shift:2|Type|Rm"     , "ARMv6T2+ IT=ANY N=W Z=W C=W"],
    ...
    ["orr"              , "Rd!=XX, Rn!=XX, Rm!=XX, {Type #Shift}"      , "T32", "11101|01|0010|0|Rn|0|Shift:3|Rd|Shift:2|Type|Rm"     , "ARMv6T2+ IT=ANY"],
    ["orrs"             , "Rd!=XX, Rn!=XX, Rm!=XX, {Type #Shift}"      , "T32", "11101|01|0010|1|Rn|0|Shift:3|Rd|Shift:2|Type|Rm"     , "ARMv6T2+ IT=ANY N=W Z=W C=W"],
    ...
    ["sbfx"             , "W:Rd!=XX, Rn!=XX, #LSB, #Width!=0"          , "T32", "11110|01|1010|0|Rn|0|LSB:3|Rd|LSB:2|0|Width-1"       , "ARMv6T2+ IT=ANY"],
    ["sdiv"             , "W:Rd!=XX, Rn!=XX, Rm!=XX"                   , "T32", "11111|01|1100|1|Rn|1111|Rd|1111|Rm"                  , "ARMv7R+  IT=ANY IDIV"],
    ...
    ["sub"              , "SP, SP, #ImmZ*4"                            , "T16", "101100001|ImmZ:7"                                    , "ARMv4T+  IT=ANY"],
    ...
    ["sub"              , "Rd!=PC, SP, #ImmA"                          , "T32", "11110|ImmA:1|0|1101|0|1101|0|ImmA:3|Rd|ImmA:8"       , "ARMv6T2+ IT=ANY"],
    ["subs"             , "Rd!=PC, SP, #ImmA"                          , "T32", "11110|ImmA:1|0|1101|1|1101|0|ImmA:3|Rd|ImmA:8"       , "ARMv6T2+ IT=ANY N=W Z=W C=W V=W"],
    ["sub"              , "Rd!=PC, SP, Rm!=XX, {Type #Shift}"          , "T32", "11101|01|1101|0|1101|0|Shift:3|Rd|Shift:2|Type:2|Rm" , "ARMv6T2+ IT=ANY"],
    ["subs"             , "Rd!=PC, SP, Rm!=XX, {Type #Shift}"          , "T32", "11101|01|1101|1|1101|0|Shift:3|Rd|Shift:2|Type:2|Rm" , "ARMv6T2+ IT=ANY N=W Z=W C=W V=W"],
    ...
    ["ubfx"             , "W:Rd!=XX, Rn!=XX, #LSB, #Width!=0"          , "T32", "11110|01|1110|0|Rn|0|LSB:3|Rd|LSB:2|0|Width-1"       , "ARMv6T2+ IT=ANY"],
    ["udiv"             , "W:Rd!=XX, Rn!=XX, Rm!=XX"                   , "T32", "11111|01|1101|1|Rn|1111|Rd|1111|Rm"                  , "ARMv7R+  IT=ANY IDIV"],
    ...
    ["adc"              , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|0101|0|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["adcs"             , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|0101|1|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["adc"              , "Rd, Rn, Rm,Type Rs"                         , "A32", "Cond|000|0101|0|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    ["adcs"             , "Rd, Rn, Rm,Type Rs"                         , "A32", "Cond|000|0101|1|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    ["add"              , "Rd, Rn, #ImmA"                              , "A32", "Cond|001|0100|0|Rn|Rd|ImmA:12"                       , "ARMv4+"],
    ["adds"             , "Rd, Rn, #ImmA"                              , "A32", "Cond|001|0100|1|Rn|Rd|ImmA:12"                       , "ARMv4+"],
    ["add"              , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|0100|0|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["adds"             , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|0100|1|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["add"              , "Rd, Rn, Rm,Type Rs"                         , "A32", "Cond|000|0100|0|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    ["adds"             , "Rd, Rn, Rm,Type Rs"                         , "A32", "Cond|000|0100|1|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    // ADR
    ["and"              , "Rd, Rn, #ImmC"                              , "A32", "Cond|001|0000|0|Rn|Rd|ImmC:12"                       , "ARMv4+"],
    ["ands"             , "Rd, Rn, #ImmC"                              , "A32", "Cond|001|0000|1|Rn|Rd|ImmC:12"                       , "ARMv4+"],
    ["and"              , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|0000|0|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["ands"             , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|0000|1|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["and"              , "Rd, Rn, Rm,Type Rs"                         , "A32", "Cond|000|0000|0|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    ["ands"             , "Rd, Rn, Rm,Type Rs"                         , "A32", "Cond|000|0000|1|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    ...
    ["bfc"              , "Rd, #LSB, #Width"                           , "A32", "Cond|011|1110|MSB|Rd|LSB|001|1111"                   , "ARMv6T2+"],
    ["bfi"              , "Rd, Rn,#LSB, #Width"                        , "A32", "Cond|011|1110|MSB|Rd|LSB|001|Rn"                     , "ARMv6T2+"],
    ["bic"              , "Rd, Rn, #ImmC"                              , "A32", "Cond|001|1110|0|Rn|Rd|ImmC:12"                       , "ARMv4+"],
    ["bics"             , "Rd, Rn, #ImmC"                              , "A32", "Cond|001|1110|1|Rn|Rd|ImmC:12"                       , "ARMv4+"],
    ["bic"              , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|1110|0|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["bics"             , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|1110|1|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["bic"              , "Rd, Rn, Rm, Type Rs"                        , "A32", "Cond|000|1110|0|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    ["bics"             , "Rd, Rn, Rm, Type Rs"                        , "A32", "Cond|000|1110|1|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    ["bkpt"             , "#Imm16"                                     , "A32", "Cond|000|1|0|0|1|0|Imm12|0111|Imm4"                  , "ARMv6+ ARMv5T"],
    ...
    ["cmn"              , "Rn, Rm, {Type #Shift}"                      , "A32", "Cond|000|1011|1|Rn|0000|Shift:5|Type|0|Rm"           , "ARMv4+"],
    ["cmp"              , "Rn, Rm, {Type #Shift}"                      , "A32", "Cond|000|1010|1|Rn|0000|Shift:5|Type|0|Rm"           , "ARMv4+"],
    ["cmn"              , "Rn, Rm, Type Rs"                            , "A32", "Cond|000|1011|1|Rn|0000|Rs|0|Type|1|Rm"              , "ARMv4+"],
    ["cmp"              , "Rn, Rm, Type Rs"                            , "A32", "Cond|000|1010|1|Rn|0000|Rs|0|Type|1|Rm"              , "ARMv4+"],
    ...
    ["dmb"              , "#ImmZ"                                      , "A32", "1111|010|1011|1|1111|1111|0000|0101|ImmZ:4"          , "?"],
    ["dsb"              , "#ImmZ"                                      , "A32", "1111|010|1011|1|1111|1111|0000|0100|ImmZ:4"          , "?"],

    ["eor"              , "Rd, Rn, #ImmC"                              , "A32", "Cond|001|0001|0|Rn|Rd|ImmC:12"                       , "ARMv4+"],
    ["eors"             , "Rd, Rn, #ImmC"                              , "A32", "Cond|001|0001|1|Rn|Rd|ImmC:12"                       , "ARMv4+"],
    ["eor"              , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|0001|0|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["eors"             , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|0001|1|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["eor"              , "Rd, Rn, Rm, Type Rs"                        , "A32", "Cond|000|0001|0|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    ["eors"             , "Rd, Rn, Rm, Type Rs"                        , "A32", "Cond|000|0001|1|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    ["eret"             , ""                                           , "A32", "Cond|000|1011|0|0000|0000|0000|0110|1110"            , "?"],

    ["hlt"              , "#Imm16"                                     , "A32", "Cond|000|1000|0|Imm16:12|0111|Imm16:4"               , "?"],
    ["hvc"              , "#Imm16"                                     , "A32", "Cond|000|1010|0|Imm16:12|0111|Imm16:4"               , "?"],
    ...
    ["ldr"              , "Rt, [Rn, {#+/-Imm12}]{!}"                   , "A32", "Cond|010|P|U|0|W|1|Rn|Rt|Imm12"                      , "ARMv4+"],
    ["ldr"              , "Rt, [Rn, +/-Rm, {Shift}]{!}"                , "A32", "Cond|011|P|U|0|W|1|Rn|Rt|Shift:5|Type|0|Rm"          , "ARMv4+"],
    ["ldrt"             , "Rt, [Rn, {#+/-Imm12}]!"                     , "A32", "Cond|010|0|U|0|1|1|Rn|Rt|Imm12"                      , "ARMv4+"],
    ["ldrt"             , "Rt, [Rn, +/-Rm, {Shift}]!"                  , "A32", "Cond|011|0|U|0|1|1|Rn|Rt|Shift:5|Type|0|Rm"          , "ARMv4+"],
    ["ldrb"             , "Rt, [Rn, {#+/-Imm12}]{!}"                   , "A32", "Cond|010|P|U|1|W|1|Rn|Rt|Imm12"                      , "ARMv4+"],
    ["ldrb"             , "Rt, [Rn, +/-Rm, {Shift}]{!}"                , "A32", "Cond|011|P|U|1|W|1|Rn|Rt|Shift:5|Type|0|Rm"          , "ARMv4+"],
    ["ldrbt"            , "Rt, [Rn, {#+/-Imm12}]!"                     , "A32", "Cond|010|0|U|1|1|1|Rn|Rt|Imm12"                      , "ARMv4+"],
    ["ldrbt"            , "Rt, [Rn, +/-Rm, {Shift}]!"                  , "A32", "Cond|011|0|U|1|1|1|Rn|Rt|Shift:5|Type|0|Rm"          , "ARMv4+"],
    ["ldrd"             , "Rt,Rt2, [Rn, {+/-Rm}]{!}"                   , "A32", "Cond|000|P|U|0|W|0|Rn|Rt|0000|1101|Rm"               , "ARMv6+ ARMv5TE"],
    ["ldrd"             , "Rt,Rt2, [Rn, {#+/-Imm8}]{!}"                , "A32", "Cond|000|P|U|1|W|0|Rn|Rt|Imm8:4|1101|Imm8:4"         , "ARMv6+ ARMv5TE"],
    ...
    ["ldrh"             , "Rt, [Rn, {#+/-Imm8}]{!}"                    , "A32", "Cond|000|P|U|1|W|1|Rn|Rt|Imm8:4|1011|Imm8:4"         , "ARMv4+"],
    ["ldrht"            , "Rt, [Rn, +/-Rm]!"                           , "A32", "Cond|000|0|U|0|1|1|Rn|Rt|0000|1011|Rm"               , "ARMv6T2+"],
    ["ldrht"            , "Rt, [Rn, {#+/-Imm8}]!"                      , "A32", "Cond|000|0|U|1|1|1|Rn|Rt|Imm8:4|1011|Imm8:4"         , "ARMv6T2+"],
    ["ldrsb"            , "Rt, [Rn, {+/-Rm}]{!}"                       , "A32", "Cond|000|P|U|0|W|1|Rn|Rt|0000|1101|Rm"               , "ARMv4+"],
    ["ldrsb"            , "Rt, [Rn, {#+/-Imm8}]{!}"                    , "A32", "Cond|000|P|U|1|W|1|Rn|Rt|Imm8:4|1101|Imm8:4"         , "ARMv4+"],
    ["ldrsbt"           , "Rt, [Rn, +/-Rm]!"                           , "A32", "Cond|000|0|U|0|1|1|Rn|Rt|0000|1011|Rm"               , "ARMv6T2+"],
    ["ldrsbt"           , "Rt, [Rn, {#+/-Imm8}]!"                      , "A32", "Cond|000|0|U|1|1|1|Rn|Rt|Imm8:4|1011|Imm8:4"         , "ARMv6T2+"],
    ["ldrsh"            , "Rt, [Rn, {+/-Rm}]{!}"                       , "A32", "Cond|000|P|U|0|W|1|Rn|Rt|0000|1111|Rm"               , "ARMv4+"],
    ["ldrsh"            , "Rt, [Rn, {#+/-Imm8}]{!}"                    , "A32", "Cond|000|P|U|1|W|1|Rn|Rt|Imm8:4|1111|Imm8:4"         , "ARMv4+"],
    ["ldrsht"           , "Rt, [Rn, +/-Rm]!"                           , "A32", "Cond|000|0|U|0|1|1|Rn|Rt|0000|1111|Rm"               , "ARMv6T2+"],
    ["ldrsht"           , "Rt, [Rn, {#+/-Imm8}]!"                      , "A32", "Cond|000|0|U|1|1|1|Rn|Rt|Imm8:4|1111|Imm8:4"         , "ARMv6T2+"],
    ...
    ["mcr"              , "#CoProc, #Opc1, Rt, CRn, CRm, {#Opc2}"      , "A32", "Cond|111|0|Opc1:2|0|CRn:4|Rt|CoProc:4|Opc2:2|1|CRm:4", "?"],
    ["mcrr"             , "#CoProc, #Opc1, Rt, Rt2, CRm"               , "A32", "Cond|110|0010|0|Rt2|Rt|CoProc:4|Opc1:2|CRm:4"        , "?"],
    ...
    ["mrc"              , "#CoProc, #Opc1, Rt, CRn, CRm, {#Opc2}"      , "A32", "Cond|111|0|Opc1:2|1|CRn:4|Rt|CoProc:4|Opc2:2|1|CRm:4", "?"],
    ["mrrc"             , "#CoProc, #Opc1, Rt, Rt2, CRm"               , "A32", "Cond|110|0010|1|Rt2|Rt|CoProc:4|Opc1:2|CRm:4"        , "?"],
    // MRS/MSR <banked_reg>
    ["mrs"              , "Rd, SpecReg"                                , "A32", "Cond|000|1|0|0|0|0|1111|Rd|0000|0000|0000"           , "ARMv4+"],
    ["msr"              , "SpecReg, #ImmA"                             , "A32", "Cond|001|1|0|R|1|0|Mask|1111|ImmA:12"                , "ARMv4+"],
    ["msr"              , "SpecReg, Rn"                                , "A32", "Cond|000|1|0|R|1|0|Mask|1111|0000|0000|Rn"           , "ARMv4+"],
    ...
    ["mvn"              , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|1111|0|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["mvns"             , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|1111|1|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["mvn"              , "Rd, Rn, Rm, Type Rs"                        , "A32", "Cond|000|1111|0|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    ["mvns"             , "Rd, Rn, Rm, Type Rs"                        , "A32", "Cond|000|1111|1|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    ...
    ["orr"              , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|1100|0|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["orrs"             , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|1100|1|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["orr"              , "Rd, Rn, Rm, Type Rs"                        , "A32", "Cond|000|1100|0|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    ["orrs"             , "Rd, Rn, Rm, Type Rs"                        , "A32", "Cond|000|1100|1|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    ...
    ["pld"              , "[Rn, +/-Rm, {Shift}]"                       , "A32", "1111|011|1|U|10|1|Rn|Shift:5|Type|0|Rm"              , "?"],
    ["pldw"             , "[Rn, #+/-Imm12]"                            , "A32", "1111|010|1|U|00|1|Rn|1111|Imm12"                     , "?"],
    ["pldw"             , "[Rn, +/-Rm, {Shift}]"                       , "A32", "1111|011|1|U|00|1|Rn|Shift:5|Type|0|Rm"              , "?"],
    ["pli"              , "[Rn, #+/-Imm12]"                            , "A32", "1111|010|0|U|10|1|Rn|1111|Imm12"                     , "?"],
    ["pli"              , "[Rn, +/-Rm, {Shift}]"                       , "A32", "1111|011|0|U|10|1|Rn|Shift:5|Type|0|Rm"              , "?"],
    // POP/PUSH

    ["qadd"             , "Rd, Rn, Rm"                                 , "A32", "Cond|000|1000|0|Rm|Rd|0000|0101|Rn"                  , "ARMv6+ ARMv5TE"],
    ...
    ["qdadd"            , "Rd, Rn, Rm"                                 , "A32", "Cond|000|1010|0|Rm|Rd|0000|0101|Rn"                  , "ARMv6+ ARMv5TE"],
    ["qdsub"            , "Rd, Rn, Rm"                                 , "A32", "Cond|000|1011|0|Rm|Rd|0000|0101|Rn"                  , "ARMv6+ ARMv5TE"],
    ["qsax"             , "Rd, Rn, Rm"                                 , "A32", "Cond|011|0001|0|Rn|Rd|1111|0101|Rm"                  , "ARMv6+"],
    ["qsub"             , "Rd, Rn, Rm"                                 , "A32", "Cond|000|1001|0|Rm|Rd|0000|0101|Rn"                  , "ARMv6+ ARMv5TE"],
    ...
    ["rsb"              , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|0011|0|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["rsbs"             , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|0011|1|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["rsb"              , "Rd, Rn, Rm, Type Rs"                        , "A32", "Cond|000|0011|0|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    ["rsbs"             , "Rd, Rn, Rm, Type Rs"                        , "A32", "Cond|000|0011|1|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    ["rsc"              , "Rd, Rn, #ImmA"                              , "A32", "Cond|001|0111|0|Rn|Rd|ImmA:12"                       , "ARMv4+"],
    ["rscs"             , "Rd, Rn, #ImmA"                              , "A32", "Cond|001|0111|1|Rn|Rd|ImmA:12"                       , "ARMv4+"],
    ["rsc"              , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|0111|0|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["rscs"             , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|0111|1|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["rsc"              , "Rd, Rn, Rm, Type Rs"                        , "A32", "Cond|000|0111|0|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    ["rscs"             , "Rd, Rn, Rm, Type Rs"                        , "A32", "Cond|000|0111|1|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    ...
    ["sbc"              , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|0110|0|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["sbcs"             , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|0110|1|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["sbc"              , "Rd, Rn, Rm,Type Rs"                         , "A32", "Cond|000|0110|0|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    ["sbcs"             , "Rd, Rn, Rm,Type Rs"                         , "A32", "Cond|000|0110|1|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    ["sbfx"             , "Rd, Rn,#LSB,#Width"                         , "A32", "Cond|011|1101|Width-1|Rd|LSB|101|Rn"                 , "ARMv6T2+"],
    ["sdiv"             , "Rd, Rn, Rm"                                 , "A32", "Cond|011|1000|1|Rd|1111|Rm|0001|Rn"                  , "ARMv8+ IDIV"],
    ...
    ["smc"              , "#Imm4"                                      , "A32", "Cond|000|1|0|0|1|0|0000|0000|0000|0111|Imm4"         , "SECURITY"],
    ...
    ["smulbb"           , "Rd, Rn, Rm"                                 , "A32", "Cond|000|1011|0|Rd|SBZ|Rm|1000|Rn"                   , "ARMv6+ ARMv5TE"],
    ["smulbt"           , "Rd, Rn, Rm"                                 , "A32", "Cond|000|1011|0|Rd|SBZ|Rm|1100|Rn"                   , "ARMv6+ ARMv5TE"],
    ["smultb"           , "Rd, Rn, Rm"                                 , "A32", "Cond|000|1011|0|Rd|SBZ|Rm|1010|Rn"                   , "ARMv6+ ARMv5TE"],
    ["smultt"           , "Rd, Rn, Rm"                                 , "A32", "Cond|000|1011|0|Rd|SBZ|Rm|1110|Rn"                   , "ARMv6+ ARMv5TE"],
    ...
    ["smulwb"           , "Rd, Rn, Rm"                                 , "A32", "Cond|000|1001|0|Rd|SBZ|Rm|1010|Rn"                   , "ARMv6+ ARMv5TE"],
    ["smulwt"           , "Rd, Rn, Rm"                                 , "A32", "Cond|000|1001|0|Rd|SBZ|Rm|1110|Rn"                   , "ARMv6+ ARMv5TE"],
    ...
    ["ssat"             , "Rd, #Imm5, Rn, {Type #Shift}"               , "A32", "Cond|011|0101|Imm5|Rd|Shift:5|SDir|01|Rn"            , "ARMv6+"],
    ["ssat16"           , "Rd, #Imm4, Rn"                              , "A32", "Cond|011|0101|0|Imm4|Rd|1111|0011|Rn"                , "ARMv6+"],
    ...
    ["str"              , "Rt, [Rn, {#+/-Imm12}]{!}"                   , "A32", "Cond|010|P|U|0|W|0|Rn|Rt|Imm12"                      , "ARMv4+"],
    ["str"              , "Rt, [Rn, +/-Rm, {Shift}]{!}"                , "A32", "Cond|011|P|U|0|W|0|Rn|Rt|Shift:5|Type|0|Rm"          , "ARMv4+"],
    ["strt"             , "Rt, [Rn, {#+/-Imm12}]!"                     , "A32", "Cond|010|0|U|0|1|0|Rn|Rt|Imm12"                      , "ARMv4+"],
    ["strt"             , "Rt, [Rn, +/-Rm, {Shift}]!"                  , "A32", "Cond|011|0|U|0|1|0|Rn|Rt|Shift:5|Type|0|Rm"          , "ARMv4+"],
    ["strb"             , "Rt, [Rn, {#+/-Imm12}]{!}"                   , "A32", "Cond|010|P|U|1|W|0|Rn|Rt|Imm12"                      , "ARMv4+"],
    ["strb"             , "Rt, [Rn, +/-Rm, {Shift}]{!}"                , "A32", "Cond|011|P|U|1|W|0|Rn|Rt|Shift:5|Type|0|Rm"          , "ARMv4+"],
    ["strbt"            , "Rt, [Rn, {#+/-Imm12}]!"                     , "A32", "Cond|010|0|U|1|1|0|Rn|Rt|Imm12"                      , "ARMv4+"],
    ["strbt"            , "Rt, [Rn, +/-Rm, {Shift}]!"                  , "A32", "Cond|011|0|U|1|1|0|Rn|Rt|Shift:5|Type|0|Rm"          , "ARMv4+"],
    ["strd"             , "Rt, Rt2, [Rn, {+/-Rm}]{!}"                  , "A32", "Cond|000|P|U|0|W|0|Rn|Rt|0000|1111|Rm"               , "ARMv4+"],
    ["strd"             , "Rt, Rt2, [Rn, {#+/-Imm8}]{!}"               , "A32", "Cond|000|P|U|1|W|0|Rn|Rt|Imm8:4|1111|Imm8:4"         , "ARMv4+"],
    ...
    ["strh"             , "Rt, [Rn, {#+/-Imm8}]{!}"                    , "A32", "Cond|000|P|U|1|W|0|Rn|Rt|Imm8:4|1011|Imm8:4"         , "ARMv4+"],
    ["strh"             , "Rt, [Rn, +/-Rm]{!}"                         , "A32", "Cond|000|P|U|0|W|0|Rn|Rt|0000|1011|Rm"               , "ARMv4+"],
    ["strht"            , "Rt, [Rn, {#+/-Imm8}]!"                      , "A32", "Cond|000|0|U|1|1|0|Rn|Rt|Imm8:4|1011|Imm8:4"         , "ARMv6T2+"],
    ...
    ["sub"              , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|0010|0|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["subs"             , "Rd, Rn, Rm, {Type #Shift}"                  , "A32", "Cond|000|0010|1|Rn|Rd|Shift:5|Type|0|Rm"             , "ARMv4+"],
    ["sub"              , "Rd, Rn, Rm, Type Rs"                        , "A32", "Cond|000|0010|0|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    ["subs"             , "Rd, Rn, Rm, Type Rs"                        , "A32", "Cond|000|0010|1|Rn|Rd|Rs|0|Type|1|Rm"                , "ARMv4+"],
    ["svc"              , "#Imm24"                                     , "A32", "Cond|111|1|Imm24"                                    , "?"],
    ...
    ["teq"              , "Rn, Rm, {Type #Shift}"                      , "A32", "Cond|000|1001|1|Rn|0000|Shift:5|Type|0|Rm"           , "ARMv4+"],
    ["tst"              , "Rn, Rm, {Type #Shift}"                      , "A32", "Cond|000|1000|1|Rn|0000|Shift:5|Type|0|Rm"           , "ARMv4+"],
    ["teq"              , "Rn, Rm, Type Rs"                            , "A32", "Cond|000|1001|1|Rn|0000|Rs|0|Type|1|Rm"              , "ARMv4+"],
    ["tst"              , "Rn, Rm, Type Rs"                            , "A32", "Cond|000|1000|1|Rn|0000|Rs|0|Type|1|Rm"              , "ARMv4+"],
    ...
    ["ubfx"             , "Rd, Rn, #LSB, #Width"                       , "A32", "Cond|011|1111|Width-1|Rd|LSB|101|Rn"                 , "ARMv6T2+"],
    ["udf"              , "Imm16"                                      , "A32", "1110|011|1111|1|Imm16:12|1111|Imm16:4"               , "?"],
    ["udiv"             , "Rd, Rn, Rm"                                 , "A32", "Cond|011|1001|1|Rd|1111|Rm|0001|Rn"                  , "ARMv8+ IDIV"],
    ...
    ["usat"             , "Rd, #Imm5, Rn, {Type #Shift}"               , "A32", "Cond|011|0111|Imm5|Rd|Shift:5|SDir|01|Rn"            , "ARMv6+"],
    ["usat16"           , "Rd, #Imm4, Rn"                              , "A32", "Cond|011|0111|0|Imm4|Rd|1111|0011|Rn"                , "ARMv6+"],
